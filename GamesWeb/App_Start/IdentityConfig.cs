...
namespace GamesWeb
{
    ...
    public class ApplicationUserManager : UserManager<IdentityModels>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<IdentityModels>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<IdentityModels>
            {
